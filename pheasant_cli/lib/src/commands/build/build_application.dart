...
Future<void> buildApplication(Progress progress, Logger logger,
    ProcessManager manager, ArgResults results) async {
  progress = logger.progress('Cleaning Cache');
  var cacheClean =
      await manager.spawnDetached('dart', ['run', 'build_runner', 'clean']);
